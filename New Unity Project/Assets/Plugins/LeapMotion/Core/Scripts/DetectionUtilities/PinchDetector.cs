...
namespace Leap.Unity {
  ...
  public class PinchDetector : AbstractHoldDetector {
    ...
    private float GetPinchDistance(Hand hand) {
      ...
      var middleTipPosition = hand.GetMiddle().TipPosition.ToVector3();
      return Vector3.Distance(indexTipPosition, middleTipPosition);
    }
    ...
    protected override void ensureUpToDate() {
      ...
      _position = ((hand.Fingers[2].TipPosition + hand.Fingers[1].TipPosition) * .5f).ToVector3();
